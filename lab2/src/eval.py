...
def main():
    ...
    with accelerator.local_main_process_first():
        train_loader = DataLoader(make_cifar(train=True, download=True), batch_size=cfg.batch_size, shuffle=True)
        test_loader = DataLoader(make_cifar(train=False, download=True), batch_size=cfg.batch_size, shuffle=False)
